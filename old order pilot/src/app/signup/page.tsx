      ...
      <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-120px)] py-12 px-4 sm:px-6 lg:px-8">
        <Card className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
             ...
             <CardDescription className="text-white/80 text-base font-normal">
               Create your restaurant account and start managing orders like a pro
             </CardDescription>
           </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            {success && (
              <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-4 py-3 rounded-lg backdrop-blur">
                {success}
              </div>
            )}
            ...
            <div className="text-center pt-4">
              <p className="text-sm text-white/70">
                ...
                <Link href="/login" className="font-medium text-[#ae8d5e] hover:text-[#9a7d4e] transition-colors">
                  Sign in
                </Link>
              </p>
            </div>
